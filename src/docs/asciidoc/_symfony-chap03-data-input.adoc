...
----
  /**
  * @Route("/hello/{nom}", methods={"GET"}, name="app_hello")
  */
...
====
[start=5]
. (plus difficile) Ajouter un *message flash* (concept à étudier !), qui affiche un message de bienvenue à
l'utilisateur lors d'une *première connection* à la route `/hello` (et sa méthode d'action liée),
