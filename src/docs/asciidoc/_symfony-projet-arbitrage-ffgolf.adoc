= Projet Play&Rthm-AmateurGolfCompetition
ifndef::backend-pdf[]
:imagesdir: images
endif::[]
...
* Fichier Excel d'une compétition, provenant de la FFGolf : link:images/export_liste_des_departs.xlsx[export_liste_des_departs.xlsx]

* Exemple de structure attendue de cadences de jeu : link:images/arbitre_cadences_de_jeu-_20190806.pdf[arbitre_cadences_de_jeu-_20190806.pdf]
...
==== 1. Analyse et travaux préparatoires
...
==== 2. Première itération (18 octobre 2019 - 11H)
...
==== 3. Livraison le jeudi 07 novembre 12h

    • Rapport technique complet

    • URL ver un dépôt git distant et public avec un descriptif README
