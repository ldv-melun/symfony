...
* Fichier Excel d'une compétition, provenant de la FFGolf : link:export_liste_des_departs.xlsx[export_liste_des_departs.xlsx]

* Exemple de structure attendue de cadences de jeu : link:arbitre_cadences_de_jeu_20190806-new.pdf[arbitre_cadences_de_jeu_20190806-new.pdf]
